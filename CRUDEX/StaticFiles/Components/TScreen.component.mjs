...
export default class TScreen extends HTMLElement{
    #LastMessage = "";
    #Message = "";
    #BackgroundImage = "";
    #BlinkMessage = false;
    ...
    constructor(styles, images, withBackgroundImage) {
        ...
        this.appendChild(this.#HTML.Main);
        ...
        this.appendChild(this.#HTML.Message);
    }
