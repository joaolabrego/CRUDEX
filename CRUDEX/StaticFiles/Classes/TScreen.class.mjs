...
export default class TScreen {
    ...
    static #Update() {
        ...
        if (this.#HTML.Date.textContent.toUpperCase() !== localdate)
            this.#HTML.Date.textContent = localdate;

        if (this.#HTML.Time.textContent.toUpperCase() !== localtime)
            this.#HTML.Time.textContent = localtime;

        if (this.#BlinkMessage && this.#HTML.Message.textContent)
            this.#HTML.Message.textContent = "";
        else if (this.#HTML.Message.textContent.toUpperCase() !== this.#Message.toUpperCase())
            this.#HTML.Message.textContent = this.#Message;
    }
    ...
    static set Message(value) {
        this.#Message = this.#HTML.Message.textContent = value;
    ...
    static set UserName(value) {
        this.#HTML.UserName.textContent = value;
    }
    /**
     * @param {boolean} value
     */
