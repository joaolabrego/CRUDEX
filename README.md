...
O CRUDEX se encarrega de gerar automaticamente o script DDLs e DMLs do sistema sendo especificado, juntamente com os scripts de stored procedures responsáveis pela execução das operações de CRUD.
