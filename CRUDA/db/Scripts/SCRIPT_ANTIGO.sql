...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure TypesUpdate: ',
@W_Id tinyint = CAST(JSON_VALUE(@Record, '$.Id') AS tinyint),
@W_CategoryId tinyint = CAST(JSON_VALUE(@Record, '$.CategoryId') AS tinyint),
@W_Name varchar(25) = CAST(JSON_VALUE(@Record, '$.Name') AS varchar(25)),
@W_Minimum sql_variant = CAST(JSON_VALUE(@Record, '$.Minimum') AS sql_variant),
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure MasksUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_Name varchar(25) = CAST(JSON_VALUE(@Record, '$.Name') AS varchar(25)),
@W_Mask varchar(MAX) = CAST(JSON_VALUE(@Record, '$.Mask') AS varchar(MAX))
IF @W_Id IS NULL BEGIN
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure DomainsUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_TypeId tinyint = CAST(JSON_VALUE(@Record, '$.TypeId') AS tinyint),
@W_MaskId bigint = CAST(JSON_VALUE(@Record, '$.MaskId') AS bigint),
@W_Name varchar(25) = CAST(JSON_VALUE(@Record, '$.Name') AS varchar(25)),
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure SystemsUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_Name varchar(25) = CAST(JSON_VALUE(@Record, '$.Name') AS varchar(25)),
@W_Description varchar(50) = CAST(JSON_VALUE(@Record, '$.Description') AS varchar(50)),
@W_ClientName varchar(15) = CAST(JSON_VALUE(@Record, '$.ClientName') AS varchar(15)),
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure MenusUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_SystemId bigint = CAST(JSON_VALUE(@Record, '$.SystemId') AS bigint),
@W_Sequence smallint = CAST(JSON_VALUE(@Record, '$.Sequence') AS smallint),
@W_Caption varchar(20) = CAST(JSON_VALUE(@Record, '$.Caption') AS varchar(20)),
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure UsersUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_Name varchar(25) = CAST(JSON_VALUE(@Record, '$.Name') AS varchar(25)),
@W_Password varchar(256) = CAST(JSON_VALUE(@Record, '$.Password') AS varchar(256)),
@W_FullName varchar(50) = CAST(JSON_VALUE(@Record, '$.FullName') AS varchar(50)),
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure SystemsUsersUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_SystemId bigint = CAST(JSON_VALUE(@Record, '$.SystemId') AS bigint),
@W_UserId bigint = CAST(JSON_VALUE(@Record, '$.UserId') AS bigint),
@W_Description varchar(50) = CAST(JSON_VALUE(@Record, '$.Description') AS varchar(50))
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure DatabasesUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_Name varchar(25) = CAST(JSON_VALUE(@Record, '$.Name') AS varchar(25)),
@W_Description varchar(50) = CAST(JSON_VALUE(@Record, '$.Description') AS varchar(50)),
@W_Alias varchar(25) = CAST(JSON_VALUE(@Record, '$.Alias') AS varchar(25)),
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure SystemsDatabasesUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_SystemId bigint = CAST(JSON_VALUE(@Record, '$.SystemId') AS bigint),
@W_DatabaseId bigint = CAST(JSON_VALUE(@Record, '$.DatabaseId') AS bigint),
@W_Description varchar(50) = CAST(JSON_VALUE(@Record, '$.Description') AS varchar(50))
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure TablesUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_Name varchar(25) = CAST(JSON_VALUE(@Record, '$.Name') AS varchar(25)),
@W_Alias varchar(25) = CAST(JSON_VALUE(@Record, '$.Alias') AS varchar(25)),
@W_Description varchar(50) = CAST(JSON_VALUE(@Record, '$.Description') AS varchar(50)),
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure DatabasesTablesUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_DatabaseId bigint = CAST(JSON_VALUE(@Record, '$.DatabaseId') AS bigint),
@W_TableId bigint = CAST(JSON_VALUE(@Record, '$.TableId') AS bigint),
@W_Description varchar(50) = CAST(JSON_VALUE(@Record, '$.Description') AS varchar(50))
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure ColumnsUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_TableId bigint = CAST(JSON_VALUE(@Record, '$.TableId') AS bigint),
@W_Sequence smallint = CAST(JSON_VALUE(@Record, '$.Sequence') AS smallint),
@W_DomainId bigint = CAST(JSON_VALUE(@Record, '$.DomainId') AS bigint),
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure IndexesUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_DatabaseId bigint = CAST(JSON_VALUE(@Record, '$.DatabaseId') AS bigint),
@W_TableId bigint = CAST(JSON_VALUE(@Record, '$.TableId') AS bigint),
@W_Name varchar(50) = CAST(JSON_VALUE(@Record, '$.Name') AS varchar(50)),
...
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure IndexkeysUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_IndexId bigint = CAST(JSON_VALUE(@Record, '$.IndexId') AS bigint),
@W_Sequence smallint = CAST(JSON_VALUE(@Record, '$.Sequence') AS smallint),
@W_ColumnId bigint = CAST(JSON_VALUE(@Record, '$.ColumnId') AS bigint),
...
CREATE INDEX [UNQ_Logs_System_User_Logged] ON [dbo].[Logs]([SystemId] ASC,[UserId] ASC,[Logged] ASC)
GO
/**********************************************************************************
Criar procedure LogsCreate
**********************************************************************************/
IF(SELECT object_id('LogsCreate', 'P')) IS NULL
EXEC('CREATE PROCEDURE [dbo].[LogsCreate] AS PRINT 1')
GO
ALTER PROCEDURE[dbo].[LogsCreate](
@UserName VARCHAR(25)
,@Record VARCHAR(MAX)
) AS BEGIN
BEGIN TRY
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure LogsCreate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_SystemId bigint = CAST(JSON_VALUE(@Record, '$.SystemId') AS bigint),
@W_UserId bigint = CAST(JSON_VALUE(@Record, '$.UserId') AS bigint),
...
THROW 51000, @ErrorMessage, 1
END
IF EXISTS(SELECT 1 FROM [dbo].[Logs] WHERE Id = @W_Id
) BEGIN
SET @ErrorMessage = @ErrorMessage + 'Chave-primária já existe na tabela Logs.';
THROW 51000, @ErrorMessage, 1
END
...
GO
/**********************************************************************************
Criar procedure LogsUpdate
**********************************************************************************/
IF(SELECT object_id('LogsUpdate', 'P')) IS NULL
EXEC('CREATE PROCEDURE [dbo].[LogsUpdate] AS PRINT 1')
GO
ALTER PROCEDURE[dbo].[LogsUpdate](
@UserName VARCHAR(25)
,@Record VARCHAR(MAX)
) AS BEGIN
BEGIN TRY
SET NOCOUNT ON
SET TRANSACTION ISOLATION LEVEL READ COMMITTED
DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure LogsUpdate: ',
@W_Id bigint = CAST(JSON_VALUE(@Record, '$.Id') AS bigint),
@W_SystemId bigint = CAST(JSON_VALUE(@Record, '$.SystemId') AS bigint),
@W_UserId bigint = CAST(JSON_VALUE(@Record, '$.UserId') AS bigint),
@W_Logged bit = CAST(JSON_VALUE(@Record, '$.Logged') AS bit)
...
THROW 51000, @ErrorMessage, 1
END
IF NOT EXISTS(SELECT 1 FROM [dbo].[Logs] WHERE Id = @W_Id
) BEGIN
SET @ErrorMessage = @ErrorMessage + 'Chave-primária não existe na tabela Logs.';
THROW 51000, @ErrorMessage, 1
END
UPDATE [dbo].[Logs] SET
[SystemId] = @W_SystemId,
...
GO
/**********************************************************************************
Criar procedure LogsRead
**********************************************************************************/
IF(SELECT object_id('LogsRead', 'P')) IS NULL
EXEC('CREATE PROCEDURE [dbo].[LogsRead] AS PRINT 1')
GO
ALTER PROCEDURE[dbo].[LogsRead](
@UserName VARCHAR(25),
@Record VARCHAR(MAX)) AS BEGIN
BEGIN TRY
	...
	BEGIN TRY
		...
		SELECT	'RecordTable' AS [ClassName]
			...
			WHERE [T].[Name] = ISNULL(@TableName, [T].[Name])
					AND [D].[Name] = ISNULL(@DatabaseName, [D].[Name])
		IF @@ROWCOUNT = 0 BEGIN
...
SET QUOTED_IDENTIFIER ON
GO
CREATE FUNCTION [dbo].[TransactionsActions](@SystemName VARCHAR(25),
											@DatabaseName VARCHAR(25),
...
BEGIN
	...
	IF @Action IN ('create', 'update', 'delete', 'rollback', 'commit', 'read') BEGIN
		SELECT @SystemId = [Id]
			...
			WHERE [Name] = @SystemName
		IF @SystemId IS NULL
			SET @ErrorMessage = 'Function TransactionsActions: Sistema ' + @SystemName + ' não encontrado.'
		ELSE BEGIN
			...
			IF @DatabaseId IS NULL
				SET @ErrorMessage = 'Function TransactionsActions: Banco de dados ' + @DatabaseName + ' não encontrado.'
			ELSE BEGIN
				SELECT @TableId = [Id],
					...
					WHERE [Name] = @TableName
				IF @TableId IS NULL
					SET @ErrorMessage = 'Function TransactionsActions: Tabela ' + @TableName + ' não encontrada.'
				ELSE IF NOT EXISTS(SELECT 1
										FROM [dbo].[DatabasesTables]
										WHERE [DatabaseId] = @DatabaseId
											  AND [TableId] = @TableId)
					SET @ErrorMessage = 'Function TransactionsActions: Tabela ' + @TableName + 'não pertence ao banco-de-dados ' + @DatabaseName + '.'
				ELSE IF @Action = 'create' AND @ProcedureCreate IS NULL
					SET @ErrorMessage = 'Function TransactionsActions: Não foi definida procedure Create para a tabela ' + @TableName + '.';
				ELSE IF @Action = 'update' AND @ProcedureUpdate IS NULL
					SET @ErrorMessage = 'Function TransactionsActions: Não foi definida procedure Update para a tabela ' + @TableName + '.';
				ELSE IF @Action = 'delete' AND @ProcedureDelete IS NULL
					SET @ErrorMessage = 'Function TransactionsActions: Não foi definida procedure Delete para a tabela ' + @TableName + '.';
				ELSE IF @Action = 'read' BEGIN
					IF @ProcedureRead IS NULL
						SET @ErrorMessage = 'Function TransactionsActions: Não foi definida procedure Read para a tabela ' + @TableName + '.';
					ELSE BEGIN
		...
		END
	END ELSE
		SET @ErrorMessage = 'Function TransactionsActions: Valor ( ' + @Action + ') do parâmetro @Action é inválido.';
...
GO
/**********************************************************************************
Criar stored procedure P_TransactionsCreate
**********************************************************************************/
USE [cruda]
GO
SET ANSI_NULLS ON
...
BEGIN
	...
	SET TRANSACTION ISOLATION LEVEL READ COMMITTED
	BEGIN TRY
		EXEC [dbo].[Login] @SystemName = @SystemName
						,@UserName = @UserName
						,@Password = @Password
						,@Action = 'authenticate'
		...
		SELECT @SystemId = [SystemId],
				...
				@ErrorMessage = [ErrorMessage]
			FROM [dbo].[TransactionsActions](@SystemName, @DatabaseName, @TableName, @UserName, @Action)
		IF @ErrorMessage IS NOT NULL
			THROW 51000, @ErrorMessage, 1
		...
		END ELSE BEGIN
			...
			END ELSE IF @TransactionAction = 'delete' BEGIN
				SET @ErrorMessage = @ErrorMessage + 'Registro já deletado da tabela ' + @TableName + '.';
				THROW 51000, @ErrorMessage, 1
