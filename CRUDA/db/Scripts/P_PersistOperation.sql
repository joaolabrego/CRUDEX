...
GO
IF(SELECT object_id('[dbo].[P_PersistOperation]', 'P')) IS NULL
	EXEC('CREATE PROCEDURE [dbo].[P_PersistOperation] AS PRINT 1')
GO
ALTER PROCEDURE[dbo].[P_PersistOperation](@TransactionId BIGINT
	...
	BEGIN TRY
		...
		DECLARE @ErrorMessage VARCHAR(255) = 'Stored Procedure P_PersistOperation: '
